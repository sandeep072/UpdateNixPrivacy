...
<div class="container-fluid">
  <div class="row">
             <div class="col-md-1">
              <p>  <button type="button" class="btn">Purpose And Usages</button></p>
                  <p><button type="button" class="btn"><a href="Data_Retention.php">Data-Retention</a></button>   </p>
                 <p>  <button type="button" class="btn" ><a href="Data_Acontrol.php">Data Access Control</a></button></p>
               ...
               <p><button class="btn btn-md" type="button" id="e"><a href="DPIA.php">DPIA</a></button></p>
...
<table class="table table-bordered " id="t1">
  ...
  join final ON Intern.id = final.id join sociall ON final.id = sociall.id join dpo on sociall.id = dpo.id ORDER BY Extern.id desc limit 1";
 ...
 <?php 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <?php echo $rows['dpu']; ?></td>
      <td><?php echo $rows['process']; ?></td>
      <td><?php echo $rows['nod']; ?>
      </td>
            ...
            <select class="form-control" id="exampleSelectd">
              ...
              <option>Review</option>    
               <option>Remove</option>   
                <option>Add Purpose</option>   
                 <option>Change Purpose</option>   
     ...
     <input type="text" name="pr" class="form-control" >
      ...
      <td>
<input type="text" name="dt" class="form-control" id="date1">
      </td>
      <td>
