...
<table class="table">
  <tbody>
    <tr> 
      ...
      <td> <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="name" value="Name"></td>
    ...
    <tr>
      ...
      <td>
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="un" value="User-Name"></td>
    </tr>
    <tr>
      <th scope="row">Picture</th>
      <td>
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="pic" value="Picture">
      </td>
 ...
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="ui" value="Unique-identifier">
</td>
      ...
      <td >
   <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="bd" value="Biometric-data">
</td>     
    </tr>
  </tbody>
</table>
...
Ethnicity
  ...
  <tbody>
    <tr>
      ...
      <td> 
  <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="R" value="Race" data-width="70" data-height="32" >
      </td>
    </tr>
    <tr>
      <th scope="row">National or ethnic origin</th>
      <td>
  <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Ne" value="National or ethnic origin" data-width="70" data-height="32" >
      </td>
    ...
    <tr>
      ...
      <td>
  <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Ls" value="Languages spoken" data-width="70" data-height="32" >
      ...
      <td>
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Di" value="Dialects" data-width="70" data-height="32" >
</td>
    </tr>
      ...
      <td>
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Ac" value="Accents" data-width="70" data-height="32" >
</td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
      ...
      <td> 
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="GI" value="Gender Identity" data-width="70" data-height="32" ></td>
  
    </tr>
    <tr>
      <th scope="row">Prefrences</th>
      <td>
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Pre" value="Prefrences" data-width="70" data-height="32" ></td>

    </tr>
    <tr>
      <th scope="row">proclivites</th>
      <td>
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Pro" value="proclivites" data-width="70" data-height="32" >
</td>
    </tr>
      <tr>
      <th scope="row">fetishes</th>
      <td>
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="fe" value="fetishes" data-width="70" data-height="32" >
</td>
    </tr>
      ...
      <td >
    <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="history" value="History" data-width="70" data-height="32">
</td>
    </tr>
  </tbody>
</table>
...
or activity, on-line or off </h3>
  ...
  <tbody>
    <tr>
      ...
      <td>
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="BB" value="browsing behavior" data-width="70" data-height="32"></td>
  
    </tr>
    <tr>
      <th scope="row">Call logs</th>
      <td>
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="cl" value="Call logs" data-width="70" data-height="32"></td>

    </tr>
    <tr>
      <th scope="row">Links clicked</th>
      <td>
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Lc" value="Links clicked" data-width="70" data-height="32">
</td>
    </tr>
      <tr>
      <th scope="row">Dameanor</th><td>
 <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Da" value="Dameanor" data-width="70" data-height="32">
</td>
    </tr>
      <tr>
      <th scope="row">Attitude</th>
      <td >
  <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Attitude" value="Attitude" data-width="70" data-height="32">
</td>
    </tr>
  </tbody>
</table>
...
an individual's characteristics shared with others</h3>
  ...
  <tbody>
    <tr>
      ...
      <td> 
    <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="AR" value="Age Ranges" data-width="70" data-height="32"></td>
  
    </tr>
    <tr>
      <th scope="row">Physical traits</th>
      <td> 
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Pt" value="Physical traits" data-width="70" data-height="32"></td>

    </tr>
    <tr>
      <th scope="row">Income bracketes</th>
      <td>
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="IB" value="Income bracketes" data-width="70" data-height="32">
</td>
    </tr>
      <tr>
      <th scope="row">Geographic</th><td>
<input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Ge" value="Geographic" data-width="70" data-height="32">
</td>
    </tr>
  ...
  <tbody>
    <tr>
      ...
      <td> 
        ...
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Pmh" value="Physical and mental health" data-width="70" data-height="32"></td>
  
    </tr>
    <tr>
      <th scope="row">Drug test results</th>
      <td> 
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Dtr" value="Drug test results" data-width="70" data-height="32"></td>
    ...
    <tr>
      ...
      <td>
        ...
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Dis" value="Disabilities" data-width="70" data-height="32">
</td>
    </tr>
      <tr>
          <th scope="row">Family or individual health history</th>
          <td>
           <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Fih" value="Family or individual health history" data-width="70" data-height="32"></td>
    </tr>
      <tr>
      <th scope="row">Health records</th>
      <td >
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="HR" value="Health records" data-width="70" data-height="32">
</td>
</td>
    </tr>
        <tr>
      ...
      <td > 
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="BT" value="blood types" data-width="70" data-height="32">
</td>
    </tr>
        <tr>
      ...
      <td >
       ...
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="HC" value="DNA code" data-width="70" data-height="32">
</td>
</td>
    </tr>
...
Physical Characteristics
  ...
  <tbody>
    <tr>
      ...
      <td>  
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Dei" value="Height" data-width="70" data-height="32"></td>
  
    </tr>
    <tr>
      <th scope="row">Weight</th>
      <td> 
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="WE" value="Weight" data-width="70" data-height="32">
     </td>
    ...
    <tr>
      <th scope="row">age</th>
      <td>
         <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="age" value="age" data-width="70" data-height="32">
</td>
    </tr>
      <tr>
          <th scope="row">Skin  tone</th>
          <td>
            <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Sk" value="Skin tone" data-width="70" data-height="32"></td>
    </tr>
      <tr>
      <th scope="row">Gender</th>
      <td >
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Gender" value="Gender" data-width="70" data-height="32">
    </tr>
        <tr>
      <th scope="row">Tattoos</th>
      <td >
       <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="tabl" value="tabl" data-width="70" data-height="32">
</td>
    </tr>
        <tr>
      <th scope="row">Piercings</th>
      <td >
        <input type="checkbox"  data-toggle="toggle" data-on="YES" data-off="NO" name="Piercings" value="Piercings" data-width="70" data-height="32">
</td>
    </tr>
