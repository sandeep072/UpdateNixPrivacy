...
<div class="container-fluid">
  ...
  <div class="row">
              <div class="col-md-12">
                <div class="container-fluid">
                  <button type="button" class="btn btn-primary"><a href="details.html" style="color: white">Controllers Checklist</a></button>
<button type="button" class="btn btn-secondary"><a href="detpro.html" style="color: white">Processors Checklist</a></button>
<button type="button" class="btn btn-success"><a href="detpro.html" style="color: white">Information Securit</a></button>
