...
var total=(add*100)/22;
var sum=total.toFixed(2);
// document.getElementById("sa").innerHTML="You are" + sum + "% Aligned with GDPR Principle";
document.write("You are " + sum + "% Aligned with GDPR Principle");
// document.getElementById("d").innerHTML="You are"+sum +"% Aligned with GDRP Principle";
//    $(document).ready(function(){
//         $('#slider').slider({
            
//             slide: function( event, ui ) {
//                 $( "#slider-sum" ).html( ui.sum );
//             } 
//         });
// 	});
swal("Hello");
